...
external void isar_plus_string_free(
...
external int isar_plus_get_error(
...
external void isar_plus_connect_dart_api(
  ffi.Pointer<ffi.Void> ptr,
);

@ffi.Native<ffi.Pointer<CFilter> Function(ffi.Uint16)>()
external ffi.Pointer<CFilter> isar_plus_filter_is_null(
  int property_index,
);
...
external int isar_plus_insert_save(
...
external void isar_plus_insert_abort(
  ffi.Pointer<CIsarWriter> insert,
);
...
external void isar_plus_query_free(
  ffi.Pointer<CIsarQuery> query,
);

@ffi.Native<IsarI64 Function(ffi.Pointer<CIsarReader>)>()
external int isar_plus_read_id(
  ffi.Pointer<CIsarReader> reader,
);

@ffi.Native<ffi.Uint8 Function(ffi.Pointer<CIsarReader>, ffi.Uint32)>()
external int isar_plus_read_null(
  ffi.Pointer<CIsarReader> reader,
  int index,
);

@ffi.Native<ffi.Uint8 Function(ffi.Pointer<CIsarReader>, ffi.Uint32)>()
external int isar_plus_read_bool(
  ffi.Pointer<CIsarReader> reader,
  int index,
);

@ffi.Native<ffi.Uint8 Function(ffi.Pointer<CIsarReader>, ffi.Uint32)>()
external int isar_plus_read_byte(
  ffi.Pointer<CIsarReader> reader,
  int index,
);

@ffi.Native<ffi.Int32 Function(ffi.Pointer<CIsarReader>, ffi.Uint32)>()
external int isar_plus_read_int(
  ffi.Pointer<CIsarReader> reader,
  int index,
);
...
external int isar_plus_read_long(
  ffi.Pointer<CIsarReader> reader,
  int index,
);
...
external void isar_plus_read_free(
  ffi.Pointer<CIsarReader> reader,
);
...
external ffi.Pointer<CIsarValue> isar_plus_value_bool(
  bool value,
);

@ffi.Native<ffi.Pointer<CIsarValue> Function(IsarI64)>()
external ffi.Pointer<CIsarValue> isar_plus_value_integer(
  int value,
);

@ffi.Native<ffi.Pointer<CIsarValue> Function(ffi.Double)>()
external ffi.Pointer<CIsarValue> isar_plus_value_real(
  double value,
);
...
external int isar_plus_value_get_bool(
  ffi.Pointer<CIsarValue> value,
);

@ffi.Native<IsarI64 Function(ffi.Pointer<CIsarValue>)>()
external int isar_plus_value_get_integer(
  ffi.Pointer<CIsarValue> value,
);

@ffi.Native<ffi.Double Function(ffi.Pointer<CIsarValue>)>()
external double isar_plus_value_get_real(
  ffi.Pointer<CIsarValue> value,
);
...
external void isar_plus_value_free(
  ffi.Pointer<CIsarValue> value,
);
...
external void isar_plus_stop_watching(
...
@ffi.Native<
  ffi.Void Function(ffi.Pointer<CIsarWriter>, ffi.Uint32, ffi.Pointer<CString>)
>()
